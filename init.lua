...
local web = true
local user = "kyoukidevs" -- change if you're using a fork
...
local releaseInfo = HttpService:JSONDecode(game:HttpGetAsync("https://api.github.com/repos/" .. user .. "/hydroxide-mod/releases"))[1]
            ...
            elseif web then
                if readFile and writeFile then
                    ...
                    if (isFile and not isFile(file)) or not importCache[asset] then
                        content = game:HttpGetAsync("https://raw.githubusercontent.com/" .. user .. "/hydroxide-mod/" .. branch .. '/' .. asset .. ".lua")
                    ...
                    assets = { loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/" .. user .. "/hydroxide-mod/" .. branch .. '/' .. asset .. ".lua"), asset .. '.lua')() }
                end
            else
    ...
    elseif ran and releaseInfo.tag_name == result then
        function environment.import(asset)
            ...
            elseif web then
                ...
                if not ran then
                    content = game:HttpGetAsync("https://raw.githubusercontent.com/" .. user .. "/hydroxide-mod/refs/heads/" .. branch .. '/' .. asset .. ".lua")
                    writeFile(file, content)
                else
                    content = result
                end
